...
struct GeneralSettingsView: View {
            ...
            HStack(alignment: .center, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    Text("Accessibility permission required")
                        .font(.headline)
                    Text(
                        "Plyph needs Accessibility to read the selected text and to "
                            + "replace it. Grant access in System Settings › Privacy & "
                            + "Security › Accessibility, then reopen Plyph.")
                        .font(.caption)
    ...
    private var behaviorGroup: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                Text("Write diagnostic metadata to ~/Library/Logs/Plyph/debug.log.")
                    .font(.caption)
                    .foregroundColor(.secondary)
            }
            .padding(16)
    ...
    private func chooseApplicationsToExclude() {
        ...
        panel.message = "Plyph will not show its selection button in the selected apps."
